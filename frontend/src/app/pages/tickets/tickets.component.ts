    ...
    <div class="p-6 max-w-4xl mx-auto">
      ...
      @if (!isLoading() && tickets().length === 0) {
        <div class="text-center py-12 bg-white/5 rounded-xl border border-white/10">
          ...
          <p class="text-gray-400 text-lg mb-2">No tienes tickets aún</p>
      ...
      <div class="grid gap-4">
        @for (ticket of tickets(); track ticket.id) {
          <div class="bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl p-6 hover:border-primary-500/50 transition-all">
            <div class="flex justify-between items-start mb-4">
              ...
              @if (ticket.isUsed) {
                ...
                <span class="px-3 py-1 bg-green-500/20 text-green-400 rounded-full text-xs font-bold border border-green-500/20">
                  Activo
                </span>
              }
            </div>
            ...
            <div class="bg-white p-4 rounded-lg">
              <div class="text-center">
                ...
                <div class="w-48 h-48 mx-auto bg-gray-200 flex items-center justify-center border-2 border-gray-300 rounded">
                  <div class="text-center">
                    <p class="text-gray-600 text-xs font-bold mb-1">QR CODE</p>
                    <p class="text-gray-500 text-xs">{{ ticket.qrCode.substring(0, 8) }}...</p>
                  </div>
                </div>
                <p class="text-gray-600 text-xs mt-2">Mostrar este código en la entrada</p>
              </div>
            </div>
          </div>
        }
